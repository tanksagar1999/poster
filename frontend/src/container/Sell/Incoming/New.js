  ...
  if (products.length)
    item.map(value => {
      ...
      return dataSource.push({
        ...
        action: (
          <div>
            <Button type="success" size="medium" className="incoming-data-btn" style={{ marginBottom: 5, color: '#FFFFF' }} > Accpet</Button>
            <Button type="danger" size="medium" className="incoming-data-btn" style={{ color: '#FFF' }} > Reject</Button>
          </div>
        ),
        Source: Source,
        order_id: order_id,
