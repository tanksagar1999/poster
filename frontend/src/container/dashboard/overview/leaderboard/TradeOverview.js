                    ...
                    <Col md={12} sm={12} xs={24}>
                      <Focard>
                        <div className="focard-details growth-upward">
                          ...
                          <p className="subtitle">Restaurant Admins</p>
                            ...
                            datasets={[
                              {
                                ...
                                backgroundColor: () =>
                                  chartLinearGradient(
                                    document.getElementById("engaged"),
                                    165,
                                    {
                                      start: "#20C99710",
                                      end: "#20C99701",
                    ...
                    <Col md={12} sm={12} xs={24}>
                      <Focard>
                        <div className="focard-details growth-upward">
                          ...
                          <p className="subtitle">Cashiers</p>
                          <p className="focard-status">
                            <span className="focard-status__percentage">
                              <FeatherIcon icon="trending-up" />
                              14%
                    ...
                    <Col md={12} sm={12}>
                      <Focard>
                        <div className="focard-details growth-downward">
                          ...
                          <p className="subtitle">Menu Item</p>
                          <p className="focard-status">
                            <span className="focard-status__percentage">
                    ...
                    <Col md={12} sm={12} xs={24}>
                      <Focard>
                        <div className="focard-details growth-upward">
                          ...
                          <p className="subtitle">Blocked Admins</p>
                          <p className="focard-status">
                            <span className="focard-status__percentage">
                              <FeatherIcon icon="trending-up" />
                              14%
                            ...
                            datasets={[
                              {
                                ...
                                backgroundColor: () =>
                                  chartLinearGradient(
                                    document.getElementById("impression2"),
                                    165,
                                    {
                                      start: "#FA8B0C10",
                                      end: "#FA8B0C01",
