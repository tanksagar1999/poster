          ...
          isbutton={
            <div className="card-nav">
              <ul>
                ...
                <li
                  className={
                    state.subscribeTabActive === "month"
                      ? "active"
                      : "deactivate"
                  }
                >
                    ...
                    yAxes: [
                      {
                        ...
                        ticks: {
                          ...
                          stepSize:
                            Math.max(...youtubeSubscribeState.gained) / 5,
                          display: true,
                          min: 0,
                          padding: 10,
                        },
