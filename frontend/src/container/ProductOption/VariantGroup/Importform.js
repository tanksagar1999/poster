...
const ImportVariantGroup = () => {
  ...
  const csvData = [
    ["Varian Group Name", "Variant Name", "Variant Comment", "Sort Order"],
  ];
  ...
  const columns = [
    {
      ...
      render: (data, record) => (
        <p>{record.isShow === true ? record.variant_group_name : ""}</p>
      ),
    },
    {
      title: "Variant Name",
    ...
    },
    {
      ...
      key: "variant_comment",
      render: (data, record) => (
        <p>{record.isShow === true ? record.variant_comment : ""}</p>
      ),
    },
    {
      title: "Sort Order",
